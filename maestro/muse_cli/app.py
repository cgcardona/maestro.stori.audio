...
grep, groove-check, harmony, humanize, import, init, inspect, key, log,
merge, meter, open, play, pull, push, recall, remote, render-preview,
resolve, revert, session, show, similarity, status, swing, symbolic-ref,
tag, tempo, tempo-scale, timeline, update-ref, validate) as Typer sub-applications.
"""
