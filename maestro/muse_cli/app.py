...
motif, open, play, pull, push, recall, remote, render-preview, resolve,
revert, session, similarity, status, swing, tag, tempo, tempo-scale,
timeline, validate) as Typer sub-applications.
"""
