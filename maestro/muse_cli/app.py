...
subcommands (arrange, ask, checkout, chord-map, commit, context, describe, diff,
divergence, dynamics, export, find, grep, import, init, log, merge,
meter, open, play, pull, push, recall, remote, session, status, swing,
tag, tempo, tempo-scale) as Typer sub-applications.
"""
