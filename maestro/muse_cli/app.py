...
describe, diff, divergence, dynamics, export, find, grep, groove-check,
humanize, import, init, key, log, merge, meter, open, play, pull, push,
recall, remote, session, status, swing, tag, tempo, tempo-scale) as Typer
sub-applications.
"""
