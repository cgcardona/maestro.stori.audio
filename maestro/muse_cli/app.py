...
dynamics, emotion_diff, export, find, form, grep, import, init, log, merge,
meter, open, play, pull, push, recall, remote, session, similarity, status,
swing, tag, tempo) as Typer sub-applications.
"""
