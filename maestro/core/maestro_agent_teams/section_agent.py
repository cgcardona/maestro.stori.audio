...
from maestro.contracts.json_types import JSONValue, NoteDict, ToolCallDict, is_note_dict
from maestro.contracts.pydantic_types import unwrap
from maestro.contracts.llm_types import ChatMessage, ToolCallEntry
from maestro.core.expansion import ToolCall
from maestro.core.llm_client import LLMClient
from maestro.core.stream_utils import ReasoningBuffer
...
from maestro.core.maestro_plan_tracker import (
    _ToolCallOutcome,
    _GENERATOR_TOOL_NAMES,
    _INSTRUMENT_AGENT_TOOLS,
)
from maestro.core.maestro_editing import _apply_single_tool_call
from maestro.contracts import compute_execution_hash, verify_contract_hash
...
from maestro.core.maestro_agent_teams.signals import SectionSignals, SectionState, _state_key
from maestro.core.telemetry import compute_section_telemetry
...
async def _run_section_child(
    ...
    try:
        ...
        if contract.is_bass and section_signals:
            from maestro.config import settings as _cfg
        ...
        from maestro.protocol.events import ToolCallEvent
