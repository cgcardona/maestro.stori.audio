...
from maestro.core.prompts.system import system_prompt_base, wrap_user_request
from maestro.core.prompts.modes import editing_prompt, editing_composition_prompt, composing_prompt
from maestro.core.prompts.intent import intent_classification_prompt, INTENT_CLASSIFICATION_SYSTEM
from maestro.core.prompts.structured import (
    structured_prompt_routing_context,
    structured_prompt_context,
)
from maestro.core.prompts.position import (
    resolve_position,
    resolve_after_beat,
    sequential_context,
)
