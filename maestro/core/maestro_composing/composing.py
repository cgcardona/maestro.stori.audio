...
from maestro.contracts.json_types import JSONValue, NoteDict, RegionMetadataWire
...
from maestro.core.planner import build_execution_plan_stream, ExecutionPlan
...
from maestro.core.maestro_composing.storage import _store_variation
from maestro.core.maestro_composing.fallback import _retry_composing_as_editing
...
async def _handle_composing(
    ...
    with trace_span(trace, "planner"):
        ...
        from maestro.protocol.emitter import parse_event as _parse
        ...
        try:
            with trace_span(trace, "variation_generation", {"steps": len(plan.tool_calls)}):
                ...
                async def _on_post_tool(
                    ...
                    """
                    from maestro.core.maestro_plan_tracker.constants import _GENERATOR_TOOL_NAMES
...
async def _handle_composing_with_agent_teams(
    ...
    from maestro.core.maestro_editing import _create_editing_composition_route
    from maestro.core.executor.snapshots import capture_base_snapshot, capture_proposed_snapshot
    from maestro.models.variation import Variation
    from maestro.services.variation import get_variation_service
