...
from maestro.contracts.pydantic_types import unwrap_dict
from maestro.contracts.project_types import ProjectContext
from maestro.core.expansion import ToolCall
from maestro.core.gm_instruments import infer_gm_program
from maestro.core.plan_schemas import EditStep, ExecutionPlanSchema, GenerationStep, MixStep
from maestro.core.planner.track_matching import _build_role_to_track_map
...
def _schema_to_tool_calls(
    ...
    """
    from maestro.core.track_styling import get_track_styling
