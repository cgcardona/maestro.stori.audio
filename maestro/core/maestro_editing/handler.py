...
from maestro.core.entity_context import build_entity_context_for_llm, format_project_context

from maestro.contracts.json_types import JSONValue, ToolCallDict
from maestro.protocol.events import ToolCallWire
from maestro.core.expansion import ToolCall
from maestro.core.intent import Intent, IntentResult, SSEState
from maestro.core.llm_client import LLMClient, enforce_single_tool
...
from maestro.core.stream_utils import strip_tool_echoes
...
from maestro.core.maestro_plan_tracker import _PlanTracker, _build_step_result
...
async def _handle_editing_variation(
    ...
    from maestro.core.maestro_composing import _store_variation
