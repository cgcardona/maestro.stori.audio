...
from maestro.services.backends.base import GenerationMetadata

if TYPE_CHECKING:
    from maestro.services.neural.melody_generator import MelodyGenerationRequest, MelodyGenerationResult
...
class Text2MidiMelodyBackend:
    ...
    async def generate(self, request: MelodyGenerationRequest) -> MelodyGenerationResult:
        ...
        from maestro.services.neural.melody_generator import MelodyGenerationResult
