...
from maestro.contracts.json_types import ToolCallPreviewDict
from maestro.contracts.pydantic_types import PydanticJson, wrap_dict
...
from maestro.core.planner import preview_plan
from maestro.prompts.errors import UnsupportedPromptHeader
from maestro.core.stream_utils import SSESequencer
from maestro.protocol.emitter import ProtocolSerializationError, emit
from maestro.protocol.events import CompleteEvent, ErrorEvent
...
async def stream_maestro(
    ...
    from maestro.prompts.parser import parse_prompt as _probe_prompt
    try:
