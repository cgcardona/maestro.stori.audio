...
Endpoint summary:
  ...
  GET /musehub/ui/{repo_id}/graph                     — contributor activity / commit graph
  ...
  GET /musehub/ui/{repo_id}/context/{ref}             — context viewer page
  GET /musehub/ui/{repo_id}/embed/{ref}               — embeddable player widget (no auth, iframe-safe)
  GET /musehub/ui/{repo_id}/credits                   — dynamic credits / liner notes page
