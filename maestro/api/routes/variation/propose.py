...
from maestro.models.requests import ProposeVariationRequest
from maestro.models.variation import ProposeVariationResponse
from maestro.core.llm_client import LLMClient
from maestro.core.intent import get_intent_result_with_llm, SSEState
from maestro.core.pipeline import run_pipeline
from maestro.core.executor import execute_plan_variation
from maestro.core.state_store import get_or_create_store
from maestro.core.tracing import create_trace_context, clear_trace_context, trace_span
from maestro.auth.dependencies import require_valid_token
from maestro.auth.tokens import TokenClaims
from maestro.db import get_db
from maestro.services.budget import (
    check_budget,
    get_model_or_default,
    InsufficientBudgetError,
    BudgetError,
)
from maestro.variation.core.state_machine import VariationStatus, InvalidTransitionError
...
from maestro.variation.storage.variation_store import PhraseRecord, VariationRecord, get_variation_store
from maestro.variation.streaming.stream_router import publish_event, close_variation_stream
from maestro.api.routes.variation._state import limiter, _generation_tasks
