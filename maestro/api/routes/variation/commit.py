...
from maestro.variation.core.state_machine import can_commit
from maestro.variation.storage.variation_store import get_variation_store, VariationRecord
from maestro.api.routes.variation._state import limiter
    ...
    try:
        with trace_span(trace, "commit_variation", {"phrase_count": len(commit_request.accepted_phrase_ids)}):
            ...
            try:
                ...
                from maestro.services.muse_drift import compute_drift_report, CommitConflictPayload
