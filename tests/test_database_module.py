...
def test_get_database_url_uses_settings():
...
def test_get_database_url_defaults_to_sqlite_when_none():
...
@pytest.mark.asyncio
async def test_init_db_and_close_db_lifecycle():
...
@pytest.mark.asyncio
async def test_async_session_local_returns_context_manager_when_initialized():
