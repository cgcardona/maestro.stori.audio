...
class TestChordRootPitchClass:
    ...
    def test_flats_normalized_to_sharps_internally(self):
        assert chord_root_pitch_class("DB") == 1
    ...
    def test_minor_chord_name_still_returns_root(self):
...
class TestChordToScaleDegrees:
    ...
    def test_respects_num_degrees(self):
...
class TestChordToMidiVoicing:
    ...
    def test_c_major_four_voices_octave_4(self):
