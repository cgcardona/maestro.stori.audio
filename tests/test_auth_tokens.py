...
class TestGenerateAccessCode:
    ...
    def test_no_duration_raises(self) -> None:

        with _patch_settings():
            with pytest.raises(AccessCodeError, match="duration"):
                generate_access_code()

    def test_user_id_in_sub(self) -> None:
    ...
    def test_no_user_id_no_sub(self) -> None:
    ...
    def test_admin_flag_adds_role(self) -> None:
    ...
    def test_non_admin_has_no_role(self) -> None:
...
class TestValidateAccessCode:
    ...
    def test_valid_token_with_user_id(self) -> None:
...
class TestCreateAccessToken:
    def test_alias_returns_valid_token(self) -> None:
    ...
    def test_alias_passes_user_id(self) -> None:
    ...
    def test_alias_passes_admin(self) -> None:
...
class TestGetUserIdFromToken:
    ...
    def test_expired_token_still_returns_user_id(self) -> None:
...
class TestGetTokenExpiration:
    ...
    def test_expiration_roughly_correct(self) -> None:
    ...
    def test_token_without_exp_raises(self) -> None:
