            ...
            Phrase(
                ...
                note_changes=[
                    NoteChange(
                        ...
                        change_type="added",
                        before=None,
                        after=MidiNoteSnapshot(pitch=72, start=0.0, duration=1.0, velocity=100),
                    ),
                ],
            ),
            Phrase(
                ...
                note_changes=[
                    NoteChange(
                        note_id="nc-remove",
                        change_type="removed",
                        before=MidiNoteSnapshot(pitch=60, start=4.0, duration=2.0, velocity=80),
                        after=None,
                    ),
                ],
            ),
            Phrase(
                ...
                note_changes=[
                    NoteChange(
                        ...
                        before=MidiNoteSnapshot(pitch=64, start=8.0, duration=1.0, velocity=70),
                        after=MidiNoteSnapshot(pitch=65, start=8.0, duration=1.5, velocity=85),
                    ),
                ],
            ),
        ],
