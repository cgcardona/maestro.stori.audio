...
class TestGetProfile:
    ...
    def test_all_registered_genres(self) -> None:
...
class TestVelocityCurves:
    ...
    def test_velocities_are_modified(self) -> None:
    ...
    def test_velocities_clamped_1_127(self) -> None:
    ...
    def test_low_velocity_clamped(self) -> None:
    ...
    def test_phrase_shape_peaks_at_two_thirds(self) -> None:
    ...
    def test_crescendo_shape_increases(self) -> None:
    ...
    def test_accent_on_beat_zero(self) -> None:
    ...
    def test_ghost_notes_inserted_funk(self) -> None:
    ...
    def test_no_ghost_when_probability_zero(self) -> None:
...
class TestCCAutomation:
    ...
    def test_classical_keys_get_sustain(self) -> None:
    ...
    def test_sustain_has_down_up_pairs(self) -> None:
    ...
    def test_no_sustain_for_non_keys(self) -> None:
    ...
    def test_expression_cc11_generated(self) -> None:
    ...
    def test_expression_density_per_bar(self) -> None:
    ...
    def test_mod_wheel_cc1_generated(self) -> None:
    ...
    def test_mod_wheel_depth_range(self) -> None:
    ...
    def test_no_expression_for_drums(self) -> None:
    ...
    def test_events_sorted_by_beat(self) -> None:
...
class TestPitchBends:
    ...
    def test_trap_produces_bends(self) -> None:
    ...
    def test_bend_values_within_range(self) -> None:
    ...
    def test_cinematic_produces_bends(self) -> None:
    ...
    def test_sorted_by_beat(self) -> None:
...
class TestTimingHumanization:
    ...
    def test_notes_are_shifted(self) -> None:
    ...
    def test_jitter_magnitude(self) -> None:
    ...
    def test_techno_tight_jitter(self) -> None:
...
class TestApplyExpressiveness:
    ...
    def test_drums_skipped(self) -> None:
    ...
    def test_melody_enriched(self) -> None:
    ...
    def test_cc_events_present_for_classical_piano(self) -> None:
    ...
    def test_no_pitch_bends_for_house_chords(self) -> None:
    ...
    def test_unknown_genre_uses_defaults(self) -> None:
    ...
    def test_all_genres_produce_valid_output(self) -> None:
...
class TestCamelCaseNormalization:
    ...
    def test_apply_expressiveness_camel_no_crash(self) -> None:
    ...
    def test_camel_keys_preserved_on_output(self) -> None:
    ...
    def test_snake_keys_preserved_on_output(self) -> None:
    ...
    def test_velocity_curves_work_with_camel(self) -> None:
    ...
    def test_ghost_notes_use_camel_keys(self) -> None:
    ...
    def test_drums_skip_with_camel(self) -> None:
...
class TestMusicGeneratorExpressiveness:
    ...
    def test_apply_enriches_result(self) -> None:
    ...
    def test_drums_not_enriched(self) -> None:
