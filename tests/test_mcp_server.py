...
class TestStoriMCPServer:
    ...
    def test_get_server_info(self, mcp_server: Any) -> None:
    ...
    def test_list_tools(self, mcp_server: Any) -> None:
    ...
    def test_register_and_unregister_daw(self, mcp_server: Any) -> None:
    ...
    def test_unregister_nonexistent(self, mcp_server: Any) -> None:

        mcp_server.unregister_daw("ghost")  # Should not raise

    def test_update_project_state(self, mcp_server: Any) -> None:
    ...
    def test_update_state_nonexistent(self, mcp_server: Any) -> None:

        mcp_server.update_project_state("ghost", {"tempo": 100})  # Should not raise

    @pytest.mark.anyio
    async def test_receive_tool_response(self, mcp_server: Any) -> None:
    ...
    def test_receive_response_nonexistent_connection(self, mcp_server: Any) -> None:

        mcp_server.receive_tool_response("ghost", "req-1", {})  # Should not raise

    def test_receive_response_nonexistent_request(self, mcp_server: Any) -> None:

        cb = AsyncMock()
        mcp_server.register_daw("daw-1", cb)
        mcp_server.receive_tool_response("daw-1", "no-req", {})  # Should not raise

    def test_multiple_daw_connections(self, mcp_server: Any) -> None:
...
class TestCallTool:
    ...
    @pytest.mark.anyio
    async def test_invalid_tool_name(self, mcp_server: Any) -> None:
    ...
    @pytest.mark.anyio
    async def test_valid_daw_tool_no_connection(self, mcp_server: Any) -> None:
    ...
    @pytest.mark.anyio
    async def test_invalid_params(self, mcp_server: Any) -> None:
