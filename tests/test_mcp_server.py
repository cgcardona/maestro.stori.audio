...
Covers: MaestroMCPServer, get_server_info, list_tools, call_tool,
...
class TestMaestroMCPServer:

    def test_get_server_info(self, mcp_server: MaestroMCPServer) -> None:
    ...
    def test_list_tools(self, mcp_server: MaestroMCPServer) -> None:
    ...
    def test_register_and_unregister_daw(self, mcp_server: MaestroMCPServer) -> None:
    ...
    def test_multiple_daw_connections(self, mcp_server: MaestroMCPServer) -> None:
...
class TestCallTool:
    ...
    @pytest.mark.anyio
    async def test_invalid_tool_name(self, mcp_server: MaestroMCPServer) -> None:
    ...
    @pytest.mark.anyio
    async def test_valid_daw_tool_no_connection(self, mcp_server: MaestroMCPServer) -> None:
    ...
    @pytest.mark.anyio
    async def test_invalid_params(self, mcp_server: MaestroMCPServer) -> None:
