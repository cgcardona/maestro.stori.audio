...
> **AgentCeption type contracts** (`ABVariantResult`, `ProjectConfig`, `SwitchProjectRequest`, `switch_project`) have moved to [cgcardona/agentception](https://github.com/cgcardona/agentception).
