...
> **AgentCeption has been extracted to [cgcardona/agentception](https://github.com/cgcardona/agentception).** The Cognitive Architecture API, Role Studio, PlanSpec pipeline, and all related agent-pipeline UI/backend code now live in that standalone repository.
