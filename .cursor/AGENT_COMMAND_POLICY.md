...
```
cd /Users/gabriel/.cursor   ← worktree-relative combined commands (e.g. cd $WORKTREE && docker compose exec ...)
cd /Users/gabriel/dev       ← main workspace combined commands
```
