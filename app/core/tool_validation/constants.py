...
VALID_SF_SYMBOL_ICONS: frozenset[str] = frozenset({
    ...
    "speaker.wave.2", "speaker.wave.3", "speaker.wave.3.fill",
...
TOOL_REQUIRED_FIELDS: dict[str, list[str]] = {
    ...
    "stori_set_track_name": ["trackId", "name"],
    "stori_set_track_color": ["trackId", "color"],
    "stori_set_track_icon": ["trackId", "icon"],
    "stori_set_playhead": ["beat"],
    "stori_add_insert_effect": ["trackId", "type"],
    "stori_add_send": ["trackId", "busName"],
    "stori_ensure_bus": ["name"],
