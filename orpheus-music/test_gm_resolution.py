...
INSTRUMENT_PROGRAMS compat layer, MELODIC_INDEX_BY_INSTRUMENT compat layer.
"""
import pytest
...
class TestResolveGmProgram:
    ...
    def test_common_instruments_resolve(self, role: str, expected: int):
    ...
    def test_every_alias_resolves_to_valid_program(self):
    ...
    def test_nearly_all_programs_are_reachable(self):
    ...
    def test_world_instruments_resolve(self):
...
class TestResolveTmidixName:
    ...
    def test_piano_resolves_to_acoustic_grand(self):
        assert resolve_tmidix_name("piano") == "Acoustic Grand"

    def test_bass_resolves_to_electric_bass_finger(self):
        assert resolve_tmidix_name("bass") == "Electric Bass(finger)"

    def test_drums_resolve_to_drums(self):
        assert resolve_tmidix_name("drums") == "Drums"

    def test_percussion_resolve_to_drums(self):
...
class TestResolveMelodicIndex:
    ...
    def test_bass_family_returns_0(self):
    ...
    def test_piano_keys_returns_1(self):
    ...
    def test_other_melodic_returns_2(self):
...
class TestInstrumentProgramsCompat:
    """Tests for the dict-like INSTRUMENT_PROGRAMS wrapper."""

    def test_get_with_default(self):
        result = INSTRUMENT_PROGRAMS.get("piano")
        assert result == 0

    def test_get_unknown_returns_default(self):
        result = INSTRUMENT_PROGRAMS.get("xyzzy_404", 99)
        assert result == 99

    def test_getitem(self):
        assert INSTRUMENT_PROGRAMS["bass"] == 33

    def test_getitem_unknown_raises_keyerror(self):
        with pytest.raises(KeyError):
            _ = INSTRUMENT_PROGRAMS["xyzzy_404"]

    def test_contains(self):
        assert "piano" in INSTRUMENT_PROGRAMS
        assert "xyzzy_404" not in INSTRUMENT_PROGRAMS


class TestMelodicIndexCompat:
    """Tests for the dict-like MELODIC_INDEX_BY_INSTRUMENT wrapper."""

    def test_get_bass(self):
        assert MELODIC_INDEX_BY_INSTRUMENT.get("bass") == 0

    def test_get_piano(self):
        assert MELODIC_INDEX_BY_INSTRUMENT.get("piano") == 1

    def test_get_guitar(self):
        assert MELODIC_INDEX_BY_INSTRUMENT.get("guitar") == 2

    def test_contains(self):
        assert "bass" in MELODIC_INDEX_BY_INSTRUMENT
...
class TestDrumKeywords:
    ...
    def test_core_drum_keywords_present(self):
    ...
    def test_world_percussion_present(self):
